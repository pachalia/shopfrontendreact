export const URL_API = 'https://andreypachalia.ru/shopapi';
...
export const URL_API_PAYMENT = URL_API + '/payment';
export const URL_API_ORDER = URL_API + '/order';
export const BASE_URL = '/shopfrontendreact/';
